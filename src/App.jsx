...
import PersonnelFile from './pages/PersonnelFile.js';
import MyTraining from './pages/MyTraining.js';
import AIComplianceInServices from './pages/AIComplianceInServices.js';
import MyAnnualEducation from './pages/MyAnnualEducation.js';
import AnnualMandatoryEducation from './pages/AnnualMandatoryEducation.js';
import EmployeeTranscript from './pages/EmployeeTranscript.js';
import AnnualEducationTranscript from './pages/AnnualEducationTranscript.js';
import ManagerSkillGapDashboard from './pages/ManagerSkillGapDashboard.js';
import ClinicalSkillsChecklist from './pages/ClinicalSkillsChecklist.js';
import TrainingCoursePlayer from './pages/TrainingCoursePlayer.js';
