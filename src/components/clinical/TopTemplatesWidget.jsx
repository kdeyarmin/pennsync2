        ...
        {topTemplates.length === 0 ? (
          ...
          <div className="space-y-2">
            {topTemplates.map((template, idx) => (
              <div key={template.id} className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-gray-500 capitalize">{template.category}</p>
                </div>
