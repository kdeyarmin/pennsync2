...
export default function OASISScrubber({ 
  ...
  // Handle OASIS PDF upload and extraction
  const handleOasisFileUpload = async (e) => {
    ...
    setOasisFile(file);
    setIsUploadingOasis(true);
    
    try {
      // Upload the file
      const { file_url } = await base44.integrations.Core.UploadFile({ file });
      
      // Extract comprehensive OASIS data from the PDF
      const extractedData = await base44.integrations.Core.ExtractDataFromUploadedFile({
        ...
        json_schema: {
          ...
          properties: {
            ...
            m0100_reason_for_assessment: { type: "string", description: "SOC, ROC, Recert, Transfer, DC, Death at Home" },
            clinical_record_items: {
              ...
              properties: {
                ...
                m1028_active_diagnoses: { type: "array", items: { type: "string" } },
                m1030_therapies_at_soc: { type: "string" },
                m1033_risk_hospitalization: { type: "string" },
                m1033_risk_factors: { type: "array", items: { type: "string" } }
              }
            },
            living_situation: {
              type: "object",
              properties: {
                m1100_patient_living_situation: { type: "string" },
                m1100_code: { type: "string" }
              }
            },
            sensory_status: {
              type: "object",
              properties: {
                ...
                m1210_hearing_ability: { type: "string" },
                m1220_understanding_verbal: { type: "string" },
                m1230_speech_clarity: { type: "string" },
                m1240_pain_assessment: { type: "string" },
            ...
            integumentary_status: {
              ...
              properties: {
                ...
                m1307_oldest_stage2_pu: { type: "string" },
                m1311_stage2_pu_count: { type: "string" },
                m1311_stage3_pu_count: { type: "string" },
                m1311_stage4_pu_count: { type: "string" },
                m1311_unstageable_dti: { type: "string" },
                m1311_unstageable_non_removable: { type: "string" },
                m1311_unstageable_slough_eschar: { type: "string" },
                m1322_stage_most_problematic: { type: "string" },
                m1324_stage2_at_soc: { type: "string" },
            ...
            respiratory_status: {
              ...
              properties: {
                ...
                m1410_respiratory_treatments: { type: "array", items: { type: "string" } }
              }
            },
            cardiac_status: {
              type: "object",
              properties: {
                m1500_symptoms_heart_failure: { type: "string" }
              }
            },
            elimination_status: {
              type: "object",
              properties: {
                m1600_urinary_incontinence: { type: "string" },
                m1610_urinary_catheter: { type: "string" },
                m1620_bowel_incontinence: { type: "string" },
                m1630_bowel_ostomy: { type: "string" }
              }
            },
            neuro_emotional_status: {
              type: "object",
              properties: {
                m1700_cognitive_functioning: { type: "string" },
                m1710_confused: { type: "string" },
                m1720_anxiety_level: { type: "string" },
                m1730_phq2_depression: { type: "string" },
                m1740_cognitive_memory: { type: "string" },
                m1745_phq9_depression: { type: "string" }
              }
            },
            adl_iadl_status: {
              type: "object",
              properties: {
                ...
                m1845_toileting_hygiene: { type: "string" },
                m1850_transferring: { type: "string" },
                m1860_ambulation: { type: "string" },
                m1870_feeding: { type: "string" },
                m1880_meal_prep: { type: "string" },
                m1890_phone_use: { type: "string" },
                m1900_prior_functioning_adl: { type: "string" },
                m1910_prior_functioning_iadl: { type: "string" }
              }
            },
            medications: {
              type: "object",
              properties: {
                ...
                m2015_high_risk_drug_count: { type: "string" },
                m2020_oral_med_management: { type: "string" },
                m2030_injectable_med_management: { type: "string" },
                m2040_prior_med_management: { type: "string" }
              }
            },
            care_management: {
              type: "object",
              properties: {
                m2102_care_type: { type: "array", items: { type: "string" } },
                m2110_how_often_adl_help: { type: "string" },
                m2200_therapy_need: { type: "string" },
                m2250_therapy_plan_changes: { type: "string" }
              }
            },
            gg_functional_abilities: {
              type: "object",
              properties: {
                gg0100_prior_functioning: {
                  type: "object",
                  properties: {
                    self_care: { type: "string" },
                    indoor_mobility: { type: "string" },
                    stairs: { type: "string" },
                    functional_cognition: { type: "string" }
                  }
                },
                gg0110_prior_device_use: {
                  type: "object",
                  properties: {
                    manual_wheelchair: { type: "boolean" },
                    motorized_wheelchair: { type: "boolean" },
                    mechanical_lift: { type: "boolean" },
                    walker: { type: "boolean" },
                    orthotics: { type: "boolean" },
                    none: { type: "boolean" }
                  }
                },
                gg0130_self_care: {
                  type: "object",
                  description: "Scores: 06=Independent, 05=Setup, 04=Supervision, 03=Partial/Moderate, 02=Substantial/Maximal, 01=Dependent, 07=Refused, 09=NA, 88=Not Attempted",
                  properties: {
                    eating_soc: { type: "string" },
                    eating_dc_goal: { type: "string" },
                    oral_hygiene_soc: { type: "string" },
                    oral_hygiene_dc_goal: { type: "string" },
                    toileting_hygiene_soc: { type: "string" },
                    toileting_hygiene_dc_goal: { type: "string" },
                    shower_bathe_soc: { type: "string" },
                    shower_bathe_dc_goal: { type: "string" },
                    upper_body_dressing_soc: { type: "string" },
                    upper_body_dressing_dc_goal: { type: "string" },
                    lower_body_dressing_soc: { type: "string" },
                    lower_body_dressing_dc_goal: { type: "string" },
                    footwear_soc: { type: "string" },
                    footwear_dc_goal: { type: "string" }
                  }
                },
                gg0170_mobility: {
                  type: "object",
                  properties: {
                    roll_left_right_soc: { type: "string" },
                    roll_left_right_dc_goal: { type: "string" },
                    sit_to_lying_soc: { type: "string" },
                    sit_to_lying_dc_goal: { type: "string" },
                    lying_to_sitting_soc: { type: "string" },
                    lying_to_sitting_dc_goal: { type: "string" },
                    sit_to_stand_soc: { type: "string" },
                    sit_to_stand_dc_goal: { type: "string" },
                    chair_bed_transfer_soc: { type: "string" },
                    chair_bed_transfer_dc_goal: { type: "string" },
                    toilet_transfer_soc: { type: "string" },
                    toilet_transfer_dc_goal: { type: "string" },
                    car_transfer_soc: { type: "string" },
                    car_transfer_dc_goal: { type: "string" },
                    walk_10_feet_soc: { type: "string" },
                    walk_10_feet_dc_goal: { type: "string" },
                    walk_50_feet_soc: { type: "string" },
                    walk_50_feet_dc_goal: { type: "string" },
                    walk_150_feet_soc: { type: "string" },
                    walk_150_feet_dc_goal: { type: "string" },
                    walk_10_feet_uneven_soc: { type: "string" },
                    walk_10_feet_uneven_dc_goal: { type: "string" },
                    step_curb_soc: { type: "string" },
                    step_curb_dc_goal: { type: "string" },
                    four_steps_soc: { type: "string" },
                    four_steps_dc_goal: { type: "string" },
                    twelve_steps_soc: { type: "string" },
                    twelve_steps_dc_goal: { type: "string" },
                    picking_up_object_soc: { type: "string" },
                    picking_up_object_dc_goal: { type: "string" },
                    wheel_50_feet_soc: { type: "string" },
                    wheel_50_feet_dc_goal: { type: "string" },
                    wheel_150_feet_soc: { type: "string" },
                    wheel_150_feet_dc_goal: { type: "string" }
                  }
                }
              }
            },
            discharge_info: {
              type: "object",
              properties: {
                m2301_emergent_care: { type: "string" },
                m2310_reason_emergent: { type: "array", items: { type: "string" } },
                m2401_intervention_synopsis: { type: "array", items: { type: "string" } },
                m2410_discharge_disposition: { type: "string" },
                m2420_discharge_destination: { type: "string" }
              }
            },
            raw_oasis_text: { type: "string", description: "Full text content of OASIS document" }
          }
        }
      });

      if (extractedData.status === "success" && extractedData.output) {
        setExtractedOasisData(extractedData.output);
      }
    } catch (err) {
      console.error("Error extracting OASIS data:", err);
    }
    
    setIsUploadingOasis(false);
  };
