...
import UnifiedDocumentReview from "../smartNote/UnifiedDocumentReview";
import { logActivity, ActivityActions } from "../utils/activityLogger";

/**
 * AudioVisitCapture — record or upload a visit audio file, transcribe it into a
 * rough note, then enhance it into a compliant clinical note.
 *
 * Extracted from the former standalone Visit Scribe page so it can live as the
 * "Record / Upload" tab of the Clinical Notes hub (ClinicalDocumentation). The
 * page's old "Live Dictation" tab was dropped here because it duplicated the
 * Clinical Notes "Live Dictation" tab (both rendered RealTimeDictationScribe).
 */
