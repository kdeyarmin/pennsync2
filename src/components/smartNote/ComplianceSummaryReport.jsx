          ...
          <Card>
            ...
            <CardContent className="py-3">
              {report.compliantElements.length > 0 ? (
                ...
                <p className="text-sm text-gray-500">No compliant elements identified yet.</p>
              )}
            </CardContent>
          </Card>
              ...
              <CardContent className="py-3 space-y-2">
                {report.deficiencies.map((def, idx) => (
                  <div key={idx} className="p-2 bg-red-50 rounded border border-red-200">
                    ...
                    <p className="text-xs text-gray-700">{def.problem}</p>
                  </div>
                ))}
              </CardContent>
            </Card>
              ...
              <CardContent className="py-3">
                <div className="flex flex-wrap gap-2">
                  {report.dismissedElements.map((el, idx) => (
                    <Badge key={idx} variant="outline" className="bg-gray-50 text-gray-600 border-gray-300">
                      {el}
                    </Badge>
                  ))}
                </div>
