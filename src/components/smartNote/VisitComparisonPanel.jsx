 ...
 * visit. This is the "check the note against the chart so trends are caught"
 * step. The nurse can opt to add a purely factual change summary to the note so
 * the change is recorded ("changes can be noted in the note").
 *
 * Props:
 ...
 */
export default function VisitComparisonPanel({ comparisons = [], include = false, onToggleInclude, summary = "" }) {
