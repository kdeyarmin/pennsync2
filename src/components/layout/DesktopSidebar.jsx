...
export default function DesktopSidebar({
  ...
  return (
    <aside className={`hidden md:flex flex-col bg-gradient-to-b from-white to-slate-50 border-r border-slate-200 transition-all duration-300 ${collapsed ? 'w-16' : 'w-56'} print:hidden h-screen sticky top-0 flex-shrink-0`}>
      {/* Logo */}
