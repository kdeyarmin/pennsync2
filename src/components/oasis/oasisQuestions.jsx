    ...
    questions: [
      {
        ...
        options: [
          ...
          { value: 4, label: "4 — Bedfast, unable to transfer but able to turn and position self in bed" },
          { value: 5, label: "5 — Bedfast, unable to transfer and unable to turn and position self" },
        ],
      },
      {
        id: "m1860",
        ...
        options: [
          ...
          { value: 4, label: "4 — Requires human supervision to ambulate" },
          { value: 5, label: "5 — Chairfast, able to wheel self independently" },
          { value: 6, label: "6 — Bedfast, unable to ambulate or be up in a chair" },
        ],
      },
    ],
  },
