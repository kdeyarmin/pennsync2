...
export default function AIComplianceInServices() {
  ...
  return isAdmin ? <AIComplianceInServicesHub /> : (
    <div className="p-3 sm:p-4 md:p-6 lg:p-8 max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">AI Compliance In-Services</h1>
        <p className="text-sm sm:text-base text-gray-600">Your assigned compliance in-service trainings</p>
      </div>
