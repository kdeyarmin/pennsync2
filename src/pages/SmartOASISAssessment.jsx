  ...
  return (
    <div className="space-y-1.5">
      {question.options.map(opt => {
        ...
        return (
          <label key={opt.value}
            className={`flex items-center gap-3 p-2.5 rounded-lg border cursor-pointer transition-all ${isSelected ? "border-indigo-400 bg-indigo-50 ring-1 ring-indigo-200" : "border-gray-100 hover:border-gray-200 hover:bg-gray-50"}`}
          >
            <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${isSelected ? "border-indigo-500 bg-indigo-500" : "border-gray-300"}`}>
  ...
  return (
    <div className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm">
      ...
      >
        ...
        <div className={`w-4 h-4 rounded-full border-2 ml-1 flex items-center justify-center ${answeredCount === section.questions.length ? "border-green-500 bg-green-500" : "border-gray-300"}`}>
  ...
  return (
    <div className="w-80 flex-shrink-0 bg-white border-l border-gray-200 flex flex-col overflow-hidden">
      <Tabs defaultValue="recommendations" className="flex flex-col flex-1 overflow-hidden">
        <TabsList className="flex-shrink-0 rounded-none border-b border-gray-200 bg-gray-50 h-auto p-0">
        ...
        <TabsContent value="recommendations" className="flex-1 overflow-hidden flex flex-col mt-0 data-[state=inactive]:hidden">
          <div className="flex-shrink-0 px-4 pt-2 pb-1 bg-gradient-to-r from-indigo-50 to-purple-50 border-b">
            <p className="text-xs text-gray-400">Updates live as you complete the assessment</p>
          </div>
