...
export default function OASISReview() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">OASIS Review Center</h1>
        <p className="text-gray-600">Review and approve AI-generated OASIS suggestions</p>
      </div>
        ...
        {isAdmin && (
          <Card className="border-2 border-purple-200 bg-purple-50">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-purple-600 font-medium">Needs Approval</p>
                  <p className="text-3xl font-bold text-purple-700">{needsApproval.length}</p>
                </div>
