                  ...
                  filteredActivities.map((activity) => (
                    <TableRow key={activity.id}>
                      <TableCell className="text-sm">
                        {formatEastern(activity.created_date, 'MMM d, yyyy h:mm:ss a')}
                      </TableCell>
                      <TableCell>
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-xs bg-gray-50 p-3 rounded mt-2 border border-gray-200">
                              {activity.action === 'user_invitation_sent' && (
                                <div className="space-y-1">
                                  ...
                                  <p><span className="font-semibold">Expires:</span> {formatEastern(activity.details.expires_at, 'MMM d, yyyy h:mm a')}</p>
                                </div>
                              )}
                              {activity.action === 'invitation_resent' && (
                                <div className="space-y-1">
                                  ...
                                  <p><span className="font-semibold">New Expiration:</span> {formatEastern(activity.details.new_expires_at, 'MMM d, yyyy h:mm a')}</p>
                                </div>
                              )}
