...
import { buildSmartTemplatePrompt, buildAudioNarrativePrompt } from "../components/visit/documentVisitPrompts";
...
For questions, please contact your care team.`;
  ...
  const generateSmartTemplate = async () => {
    ...
    try {
      const prompt = buildSmartTemplatePrompt({ patient, visit, vitalSigns, previousVisit });
  ...
  const handleAudioProcessed = async (audioFile) => {
    ...
    try {
      ...
      const processAudioWrapper = async () => {
        ...
        const prompt = buildAudioNarrativePrompt({ patient, visit, vitalSigns, previousVisit, narrativeText });
