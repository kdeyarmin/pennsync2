...
Deno.serve(async (req) => {
  try {
    ...
    await base44.asServiceRole.integrations.Core.SendEmail({
      ...
      subject: `Reminder: your signature is needed — ${documentName}`,
      body: renderBrandedEmail({
        preheader: `A document is waiting for your signature: ${documentName}.`,
        eyebrow: 'Signature requested',
        title: `Hello ${patient.first_name},`,
        intro: 'This is a friendly reminder that you have a document waiting for your signature.',
        sections: [
          {
            rows: [
          ...
          {
            paragraphs: ['Please sign this document at your earliest convenience through your patient portal.'],
          },
          {
