...
Deno.serve(async (req) => {
  try {
    ...
    await base44.asServiceRole.integrations.Core.SendEmail({
      ...
      subject: 'Your PennSync by CareMetric account access',
      body: renderBrandedEmail({
        preheader: 'An administrator has reset your account access. A password-setup link is on its way.',
        eyebrow: 'Account access',
        title: `Hello ${targetUser.full_name || userEmail},`,
        intro: 'An administrator has reset your account access for PennSync by CareMetric.',
        sections: [
          {
            paragraphs: [
              'You should receive a separate email shortly with a link to set your password. Once it’s set, use the details below to sign in.',
            ],
          },
          {
            rows: [
          ...
          {
            note: 'If you do not receive the password-setup email within a few minutes, please check your spam folder or contact your administrator.',
          },
        ],
      }),
    });
